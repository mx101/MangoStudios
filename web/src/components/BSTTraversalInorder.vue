<template>
  <div>
    <div style="display: flex; justify-content: center; align-items: center;">
      <button class="btn btn-primary" name="submit" type="submit" style="margin: 0 0.75em" value="Watch Search" v-on:click="animate_path">Watch Inorder Traversal</button>
    </div>
  ...
  methods: {
    ...
    animate_path() {
      ...
      var g = svg
        .select('g')
        .attr('transform', `translate(${margin},${margin})`);
      var path = this.tree_.getInorder();
