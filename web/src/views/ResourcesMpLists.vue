<template>
  ...
  <h2 class="hover" style="padding-left:5%;font-size:40px" v-on:click="testing" id="parentconcept">
    MP Resources
  </h2>
  ...
  <h2 style="padding-bottom:30px; padding-top:30px; font-size:70px">
    Explore
  </h2>
...
<style scoped>
    ...
    #jumbotronHover:hover h2 {
        color: white;
        
    }

    #jumbotronHover:hover {
